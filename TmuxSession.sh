...
start_bot() {
    ...
    if tmux has-session -t "$SESSION" 2>/dev/null; then
        ...
        tmux new-session -d -s "$SESSION" "bash -c 'cd $FOLDER && $COMMAND && exec $SHELL'" 
...
start_bot "DESPEED" "/home/hg680p/despeedBot" "node main.js"
start_bot "TEAFI" "/home/hg680p/teaFiBot" "node main.js"
#❌start_bot "MESHCHAIN" "/home/hg680p/mesh-bot" "node main.js"
#❌start_bot "LITAS" "/home/hg680p/litasBot" "node main.js"
#❌start_bot "STREAM-Ai" "/home/hg680p/streamAi" "node main.js"
#start_bot "BERATRAX" "/home/hg680p/beratraxBot" "node main.js"
...
if ! tmux has-session -t "DAWN" 2>/dev/null; then
    tmux new-session -d -s "DAWN" "bash -c 'source /home/hg680p/venv/bin/activate && cd /home/hg680p/Dawn-BOT && python3 bot.py && exec $SHELL'"
...
echo -e "${GREEN}========================================="
echo -e "${YELLOW}   SEMUA BOT TELAH DIJALANKAN DI 
TMUX!"
echo -e "${GREEN}========================================="
